...
public class ObjectController : MonoBehaviour
{
	...
	//the prefab used to instantiate the other default objects.
	public GameObject ExplosiveObject;
	public List<GameObject> CurrentTrialSpecialObjects;

	public GameObject[] towerTargets;
	public GameObject currentTowerTarget;
	...
	void Start ()
	{
		...
		EnableTowerTargets (0, false);
		EnableTowerTargets (1, false);
	}
	...
	public void EnableTowerTargets (int targetIndex, bool isActive)
	{
		
		towerTargets [targetIndex].SetActive (isActive);
	}
	...
	public List<Vector2> GenerateOrderedDefaultObjectPositions (int numDefaultObjects, Vector3 distancePos)
	{ //ORDERED BY DISTANCE TO PLAYER START POS
