...
public class NetworkManager : MonoBehaviour
{
    ...
    {
        Debug.Log("beginning network discovery");
       ...
       // yield return StartCoroutine(SetNeuralConnectionUIStatus(false));
        ...
        Config_CoinTask.isSyncing = true;
    ...
    public void UpdateDirectIPAddress()
    {
        ...
        Config_CoinTask.isTargetIPAddrValid = parseResult;
        ...
        if (parseResult)
        {
            ...
            Config_CoinTask.directIPAddress = directIPAddress.text;
        }
        else
        {
