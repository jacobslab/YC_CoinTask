...
public class SubjectReaderWriter : MonoBehaviour {
	...
	public void RecordSubjects(){
		if( ExperimentSettings_CoinTask.currentSubject != null && !ExperimentSettings_CoinTask.isReplay && ExperimentSettings_CoinTask.isLogging){
			if(File.Exists(subjectFile)){
