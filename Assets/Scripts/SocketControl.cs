        ...
        try
        {
            ...
            while (true)
            {
                ...
                while ((i = stream.Read(bytes, 0, bytes.Length)) != 0)
                {
                    ...
                    if (parseResult)
                    {
                        Config_CoinTask.syncboxConnected = res;
                    }
                }
...
public class ClientThread : ThreadedJob
{
    ...
    protected override void ThreadFunction()
    {
        ...
        PrintSomething("about to open a tcpclient with the server address");
    ...
    IPAddress ClientSocket()
    {
        ...
        string message = "SUBJ \t" + ExperimentSettings_CoinTask.subjFolder;
