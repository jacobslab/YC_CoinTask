...
Points 3 - 12 show how to create a scene with calibration, gaze trail, data
saving, and a track box guide.

6. Drag and drop the "TobiiPro\ScreenBased\Prefabs\[EyeTracker]" prefab into the
...
7. Drag and drop the "TobiiPro\ScreenBased\Prefabs\[Calibration]" prefab into
   the scene. Select the [Calibration] prefab and in the inspector, select a key
   to be used to start a calibration.
8. Drag and drop the "TobiiPro\ScreenBased\Prefabs\[SaveData]" prefab into the
   scene. Select the [SaveData] prefab and in the inspector, select a key to be
   used to start and stop saving data.
9. Drag and drop the "TobiiPro\ScreenBased\Prefabs\[TrackBoxGuide]" prefab into
...
10. Drag and drop the "TobiiPro\ScreenBased\Prefabs\[GazeTrail]" prefab into the
    scene.
